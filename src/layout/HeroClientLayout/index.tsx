...
const defaultHeroPageData: HeroPageData = {
  badge: { text: "", icon: "", link: "" },
  title: "",
  subtitle: "",
  button: { text: "", icon: "", link: "" },
  footer: { text: "", icon: "", stats: "" },
  layout: "simple",
  theme: {
...
const defaultHeroData: HeroData = {
  ecommerce: {
    badge: { text: "O próximo passo para sua escala", icon: "", link: "" },
    ...
    button: { text: "SOLICITAR MEU DIAGNÓSTICO", icon: "ph:arrow-right-bold", link: "/contato" },
    footer: { text: "Vagas limitadas para este mês", icon: "mdi:check-decagram", stats: "" },
    layout: "simple",
    theme: { primary_color: "blue-600", secondary_color: "gray-700", text_color: "gray-900", background_color: "white", accent_color: "amber-500" }
  },
  marketing: {
    badge: { text: "Próximo Passo Lógico", icon: "mdi:lightning-bolt", link: "" },
    ...
    button: { text: "CONSTRUIR MINHA MÁQUINA DE VENDAS", icon: "lucide:arrow-right", link: "/contato" },
    footer: { text: "Empresas escaladas este ano", icon: "", stats: "+40" },
    layout: "complex",
    theme: { primary_color: "pink-600", secondary_color: "gray-800", text_color: "gray-100", background_color: "gray-900", accent_color: "rose-500" }
  },
  sobre: {
    badge: { text: "Agenda Q1/2026: <span class='text-[#1d1d1f] font-bold'>Últimas Vagas</span>", icon: "", link: "" },
    ...
    button: { text: "AGENDAR SESSÃO ESTRATÉGICA", icon: "ph:arrow-right-bold", link: "/contato" },
    footer: { text: "", icon: "", stats: [ { label: "30 Min", sublabel: "Duração da Sessão" }, { label: "Senior", sublabel: "Especialista Real" } ] },
    layout: "refined",
    theme: { primary_color: "blue-700", secondary_color: "slate-800", text_color: "slate-900", background_color: "slate-50", accent_color: "blue-500" }
  }
};
...
interface HeroClientLayoutProps {
  initialData: any;
  initialTheme?: "ecommerce" | "marketing" | "sobre";
}

export default function HeroClientLayout({ initialData, initialTheme = "ecommerce" }: HeroClientLayoutProps) {
  // A aba ativa é inicializada com o valor da prop `initialTheme`
  const [activeTheme, setActiveTheme] = useState<keyof HeroData>(initialTheme);
  ...
  const {
    ...
    apiPath: "/api/tegbe-institucional/json/call-to-action", // Ajuste para a rota correta da sua API se necessário
