...
interface HeroImagesClientLayoutProps {
  initialData: any;
...
const mergeWithDefaults = (apiData: any, defaultData: HeroImageData): HeroImageData => {
  if (!apiData) return defaultData;
  return {
    image: {
      ecommerce: apiData.image?.ecommerce || defaultData.image.ecommerce,
      marketing: apiData.image?.marketing || defaultData.image.marketing,
    },
    alt: {
      ecommerce: apiData.alt?.ecommerce || defaultData.alt.ecommerce,
      marketing: apiData.alt?.marketing || defaultData.alt.marketing,
    },
    objectPosition: {
      ecommerce: apiData.objectPosition?.ecommerce || defaultData.objectPosition.ecommerce,
      marketing: apiData.objectPosition?.marketing || defaultData.objectPosition.marketing,
    }
  };
};
...
export default function HeroImagesClientLayout({ initialData, initialTheme = "ecommerce" }: HeroImagesClientLayoutProps) {
  // ========== ESTADOS ==========
  ...
  // Se estiver carregando e não tiver initialData
  if (loading && !exists && !initialData) {
    return <Loading layout={ImageIcon} exists={!!exists} />;
  }
