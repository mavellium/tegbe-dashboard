...
interface DualShowcaseClientLayoutProps {
  initialData: any;
  initialTheme?: "marketing" | "cursos";
}

export default function DualShowcaseClientLayout({ initialData, initialTheme = "marketing" }: DualShowcaseClientLayoutProps) {
  // Inicializa o state com a prop que veio do servidor
  const [activeSection, setActiveSection] = useState<"marketing" | "cursos">(initialTheme);
