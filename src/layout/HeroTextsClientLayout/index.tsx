...
// Adicionado Props para receber os dados do servidor
interface HeroTextsClientLayoutProps {
  initialData?: any;
  initialTheme: "ecommerce" | "marketing";
}

export default function HeroTextsClientLayout({ initialData, initialTheme = "ecommerce" }: HeroTextsClientLayoutProps) {
  const [activeTheme, setActiveTheme] = useState<"ecommerce" | "marketing">(initialTheme);
  ...
  const {
    ...
    defaultData: initialData || defaultHeroTextsData, 
  });
