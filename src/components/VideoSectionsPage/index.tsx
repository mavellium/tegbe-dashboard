...
type SectionType = "sobre" | "cursos" | "ecommerce";

interface VideoSectionsData {
  sobre?: VideoPageData;
  cursos?: VideoPageData;
  ecommerce?: VideoPageData;
  defaultSection?: SectionType;
}

interface VideoSectionsPageProps {
...
const defaultVideoSectionsData: VideoSectionsData = {
  ...
  ecommerce: { ...defaultVideoPageData },
...
export default function VideoSectionsPage({ initialSection = "sobre" }: VideoSectionsPageProps) {
  ...
  const getCurrentSectionData = (): VideoPageData => {
    ...
    if (!sectionData) {
      return defaultVideoSectionsData[activeSection] || defaultVideoSectionsData.sobre!;
    }
    return sectionData;
  };
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    type="text"
                    placeholder={activeSection === "sobre" ? "Nossa História" : activeSection === "cursos" ? "Metodologia TegPro" : "Produtos Exclusivos"}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    type="text"
                    placeholder={activeSection === "sobre" ? "A excelência como único padrão" : activeSection === "cursos" ? "A caixa-preta finalmente aberta" : "A revolução no seu negócio"}
      ...
      <form onSubmit={handleSubmit} className="space-y-6 pb-32">
        <Card className="p-6 bg-[var(--color-background)]">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            />
            <SectionTab 
              sectionKey="ecommerce" 
              label="E-commerce" 
              isActive={activeSection === "ecommerce"} 
              onClick={setActiveSection}
          ...
          <div className="mt-4 p-3 rounded-lg bg-[var(--color-background-body)] border border-[var(--color-border)]">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                {activeSection === "ecommerce" && <ShoppingCart className="w-5 h-5 text-green-500" />}
                <span className="font-medium text-[var(--color-secondary)]">
                  Configurando: {activeSection === "sobre" ? "Página Sobre" : activeSection === "cursos" ? "Página de Cursos" : "Página E-commerce"}
                </span>
              </div>
              <div className="flex items-center gap-2">
            ...
            <p className="text-xs text-[var(--color-secondary)]/70 mt-1">
              {activeSection === "sobre" 
                ...
                : "Seção de vídeo para a página 'E-commerce' - foco em produtos e loja"}
            </p>
          </div>
        </Card>
